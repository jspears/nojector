...
_u.extend(Injector.prototype, {
    ...
    stringify: function (obj, ctx, property) {
        var promises = [], api = this, oret, ret = oret = {};
        var p = promise();
        JSON.stringify(obj, function (key, value) {
            ...
            if (typeof value === 'function') {
                ...
                promises.push(api.resolve(value, this, ctx).then(function (res) {
                    ret[key] = JSON.stringify(res);
                }));
                return null;
