...
/**
 * An object that holds the context in which to invoke
 * the resolvers.
 *
 * @typedef {Object} Context
 */
/**
 * A slash notation path
 * @example
 * var obj = {
 *   stuff:{ more:{ other: 1 } }
 * }
 ...
 */
/**
 * A function that takes the Context as a parameter.
 * @param {Context} context
 * @param {...*} args to pass in.
 * @typedef {Function} CtxFunction
 */
/**
...
/**
 * @namespace
 * @param {{resolvers: Array<Resolver>, search: Array<String>}} options - options to initiate peace.
 * @returns {Injector}
 * @constructor
 */
...
Injector.prototype = {
    ...
    *    //Hello Joe
    ...
    /**
     * Resolves internally to a callback.
     * @private
     * @param {Calback} cb
     * @param {Object} [scope]
     * @param {Context} ctx
     ...
     * @param {Context} ctx to stringify said object in.
    ...
    _stringify: function (ctx, pObj, pKey, obj) {
        ...
        switch (typeof obj) {
            ...
            case "number":
                ...
                return obj;
            case "function":
                //invoke is fully recursive... so prolly the better thing.
                return this.invoke(obj, [], ctx).then(this._stringify.bind(this, ctx, pObj, pKey));
            default:
            {
                if (isPromise(obj)) {
