    ...
    stringify: function (obj, ctx, promises) {
        ...
        if (isPromise(obj)) {
            ...
            JSON.stringify(obj, function (k, v) {
                ...
                if (isPromise(v)) {
                    promises.push(v.next(function (res) {
                        self.stringify(res, ctx).next(function (v) {
                            ret[k] = v;
                            return v;
                        });
                    }));
                ...
                if (typeof v === 'function') {
                    promises.push(self.resolve(v, this, ctx).next(function (res) {

                        return self.stringify(res, ctx).next(function (v) {
                            ret[k] = v;
                            return v;
                        });
                    }));
